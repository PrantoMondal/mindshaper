import 'dart:io';
import 'package:mindshaper/l10n/app_localizations.dart';import 'package:mindshaper/src/core/config/build_config.dart';
...
Exception handleNetworkError(DioException dioError) {
  switch (dioError.type) {
    case DioExceptionType.cancel:
      return ApplicationException(message: AppLocalizations.of(Get.context!)!.connectionCancelledError);
    case DioExceptionType.connectionTimeout:
      return ApplicationException(message: AppLocalizations.of(Get.context!)!.establishConnectionError);
    case DioExceptionType.unknown:
      return NetworkException(message: AppLocalizations.of(Get.context!)!.noInternetConnection);
    case DioExceptionType.receiveTimeout:
    case DioExceptionType.sendTimeout:
    case DioExceptionType.connectionError:
      return TimeoutException(message: AppLocalizations.of(Get.context!)!.establishConnectionError);
    case DioExceptionType.badCertificate:
      return ApplicationException(message: AppLocalizations.of(Get.context!)!.invalidCertificate);
    case DioExceptionType.badResponse:
      return _parseNetworkErrorResponse(dioError);
    default:
      return ApplicationException(message: AppLocalizations.of(Get.context!)!.unknownError);
  }
}
